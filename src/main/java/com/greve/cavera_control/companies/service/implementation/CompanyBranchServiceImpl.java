...
public class CompanyBranchServiceImpl implements CompanyBranchService {
    ...
    public CompanyBranch update(final Long userId, final Long id, CompanyBranch data) {
        ...
        cb.setAdressStreet(data.getAdressStreet());
        cb.setAdressNumber(data.getAdressNumber());
        cb.setAdressNeighborhood(data.getAdressNeighborhood());
        cb.setAdressCity(data.getAdressCity());
        cb.setAdressCountry(data.getAdressCountry());
        cb.setAdressComplement(data.getAdressComplement());
        cb.setAdressState(data.getAdressState());
        cb.setAdressPostalCode(data.getAdressPostalCode());
